...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      stickyUserMessagesTitle: 'تثبيت رسائل المستخدم',
      stickyUserMessagesDesc: 'احتفظ بأحدث رسالة لك مثبتة في أعلى المحادثة أثناء التمرير عبر سلاسل المحادثة الطويلة.',
