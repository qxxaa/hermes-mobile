...
export const ru = defineLocale({
  ...
  settings: {
    ...
    config: {
      ...
      toolsetsWipeConfirm:
        'Удалить все включенные toolsets? Это отключит память, терминал, веб-поиск, делегирование и большинство других инструментов, пока вы не включите их снова.',
    ...
    toolsets: {
      ...
      noProviderOptions:
        'У этого toolset нет вариантов провайдера — включите его, и он будет работать с вашей текущей конфигурацией.',
      noProviders: 'Для этого toolset сейчас нет доступных провайдеров.',
      ready: 'Готово',
  ...
  skills: {
    ...
    toolsetsEnabled: (enabled, total) => `Включено toolsets: ${enabled}/${total}`,
    configureToolset: label => `Настроить ${label}`,
    toggleToolset: (label, enabled) => `${enabled ? 'Включить' : 'Отключить'} toolset ${label}`,
    skillsLoadFailed: 'Не удалось загрузить навыки',
    toolsetsRefreshFailed: 'Не удалось обновить toolsets',
    skillEnabled: 'Навык включён',
    skillDisabled: 'Навык отключён',
    toolsetEnabled: 'Toolset включён',
    toolsetDisabled: 'Toolset отключён',
