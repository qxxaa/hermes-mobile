...
export const ru = defineLocale({
  ...
  share: {
    title: 'Поделиться в Hermes',
    textShare: 'Текст из другого приложения',
    newSession: 'Новый чат',
    searchPlaceholder: 'Поиск чатов…',
    messagePlaceholder: 'Добавить сообщение (необязательно)',
    continue: 'Продолжить',
    stagedTo: 'Черновик готов в чате',
    stagedNew: 'Черновик готов в новом чате',
    noSessions: 'Чатов пока нет',
    failed: 'Не удалось загрузить общий файл:',
  ...
  desktop: {
    ...
    fileAttachFailed: 'Не удалось прикрепить файл',
