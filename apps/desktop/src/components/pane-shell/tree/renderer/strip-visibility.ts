...
export interface StripPane {
  ...
  /**
   * Fork: hide-only chrome (sessions / Bots) keeps its panes + hide-tabs
   * affordance; upstream dropped the prop in the strip rework, but the fork's
   * pane registrations and controller still set and honor it.
   */
  hideOnly?: boolean
